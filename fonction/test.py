import json
import os
from contexte import chemin_Utilisateurs, chemin_doc_crypté, chemin_fichiers_partagés
...
def ajouter_fichier(fichier, utilisateur, cle_derivee):
    ...
    if not os.path.basename(fichier):
    ...
    try:
        ...
        rendre_public = input("Voulez-vous rendre ce fichier soit public ? (oui/non) : ").strip().lower() == "oui"
        ...
        print(viewers)
        if "all" in viewers:
            repertoire_fichier_partagee = os.path.join(chemin_fichiers_partagés, "fichiers_cryptes")
            # fichier_nom = os.path.basename(fichier)
            # print(fichier_nom)
            chemin_fichier_chiffre = os.path.join(repertoire_fichier_partagee, fichier_nom + ".chiffre")
            chemin_fichier_chiffre_coffre = os.path.join(chemin_doc_crypté, fichier_nom + ".chiffre")
            # Chiffrer le contenu
            contenu_chiffre = cobra.chiffrer_fichier(fichier, cle_derivee)
            # Ouvrir le fichier une seule fois
            ...
            for viewer in viewers:
                repertoire_invite = os.path.join(f"coffre_fort\\Utilisateurs\\{viewer}", "fichiers_cryptes")
                fichier_nom = os.path.basename(fichier)
                chemin_fichier_chiffre = os.path.join(repertoire_invite, fichier_nom + ".chiffre")
                chemin_fichier_chiffre_coffre = os.path.join(chemin_doc_crypté, fichier_nom + ".chiffre")
